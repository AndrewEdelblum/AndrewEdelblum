...
ggplot(d, aes(x = year)) +
  ...
  labs(x = "Year", y = "Count", 
       title = "Density Distribution of Top 100 Songs", 
...
ggplot(d, aes(x = decade, y = decade_count)) +
  ...
  labs(x = "Decade", 
       y = "Count", 
       title = "Favorite Songs by Decade of Release", 
...
ggplot(d, aes(x = discovery, y = disc_freq)) +
  ...
  labs(x = "Period of Discovery", 
       y = "Count", 
       title = "Favorite Songs by Period of Discovery", 
