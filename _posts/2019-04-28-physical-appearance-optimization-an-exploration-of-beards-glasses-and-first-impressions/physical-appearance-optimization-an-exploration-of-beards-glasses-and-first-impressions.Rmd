...
description: |
  I always wanted to know if facial hair impacts how old people think I am. So, I tested it.
author:
...
ggplot(summary, aes(x = beard, y = mean, fill = glasses)) +
  ...
  scale_fill_OkabeIto() +
  coord_cartesian(ylim = c(20, 30)) +
  labs(x = "Beard", y = "Perceived Age", fill = "Glasses", title = "Age, re: Beard + Glasses", subtitle = "When I'm not wearing glasses, having a beard makes me look a year and a half older", caption = "Dashed line indicates current age = 25") +
  theme(plot.title = element_text(size = 30, face = "bold", hjust = 0.5), 
        plot.subtitle = element_text(size = 15, hjust = 0.5),
...
ggplot(summary, aes(x = beard, y = mean, fill = glasses)) +
  ...
  facet_wrap(~gen) +
  scale_fill_OkabeIto() +
  labs(x = "Beard", y = "Attractiveness", fill = "Glasses", title = "Attractiveness by Gender, re: Beard + Glasses", subtitle = "Women find me most attractive with a beard and glasses") +
  theme(plot.title = element_text(size = 30, face = "bold", hjust = 0.5), 
        plot.subtitle = element_text(size = 15, hjust = 0.5),
        legend.title = element_text(size = 20, face = "bold"),
        legend.text = element_text(size = 15),
