...
ggplot(d, aes(x = sbcavg, y = donate_3)) +
  ...
  labs(x = "Self-Brand Connection (SBC)", 
       y = "Donations", 
       title = "SBC to Nike increased donations", 
...
ggplot(d, aes(x = sbcavg, y = donate_3, color = know2)) +
  ...
  labs(x = "Self-Brand Connection (SBC)", 
       y = "Donations", 
       title = "Activism awareness by SBC interaction", 
...
ggplot(d, aes(x = donate_3, fill = polit)) +
  ...
  labs(x = "Donations to BLM", 
       y = "Density", 
       fill = "Political Orientation", 
       title = "Donations to BLM by political orientation") +
  theme(plot.title = element_text(size = 30, face = "bold", hjust = 0.5), 
        plot.subtitle = element_text(size = 15, hjust = 0.5),
...
ggplot(pol, aes(x = sbc_cat, y = mean, fill = know2)) +
  ...
  labs(x = "Self-Brand Connection (SBC)", 
       y = "Donation", 
       fill = "Awareness", 
       title = "Impact of political orientation on donations", 
