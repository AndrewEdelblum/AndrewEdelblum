...
ggplot(d, aes(x = sbcavg, y = donate_3)) +
  ...
  labs(x = "Self-Brand Connection (SBC)", y = "Donations", title = "SBC to Nike increased donations", subtitle = "A 10-point increase in SBC is associated with a $0.33 boost in donation amount") +
...
ggplot(d, aes(x = sbcavg, y = donate_3, color = know2)) +
  geom_smooth(method = "lm") +
  scale_y_continuous(labels = scales::dollar) +
  labs(x = "Self-Brand Connection (SBC)", y = "Donations", title = "Activism awareness by SBC interaction", subtitle = "Stronger relationship between SBC and activism for those aware of activism", color = "Awareness") +
...
ggplot(d, aes(x = donate_3, fill = polit)) +
  ...
  labs(x = "Donations to BLM", y = "Density", fill = "Political Orientation", title = "Donations to BLM by political orientation", caption = "* = Dashed lines indicate mean donation") +
  theme(plot.title = element_text(size = 30, face = "bold", hjust = 0.5), 
        plot.subtitle = element_text(size = 15, hjust = 0.5),
        legend.title = element_text(size = 20, face = "bold"),
        legend.background = element_rect(size = .5),
...
ggplot(pol2, aes(x = sbc_cat, y = mean, fill = know2)) +
  ...
  labs(x = "Self-Brand Connection (SBC)", y = "Donation", fill = "Awareness", title = "Impact of political orientation on donations", subtitle = "SBC and awareness impacted donations to BLM for conservatives and liberals") +
  theme(plot.title = element_text(size = 30, face = "bold", hjust = 0.5), 
        plot.subtitle = element_text(size = 15, hjust = 0.5),
        legend.title = element_text(size = 20, face = "bold"),
        legend.background = element_rect(size = .5),
